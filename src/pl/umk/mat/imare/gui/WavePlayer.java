 ...
 * WavePlayer.java
 *
 * Created on 2010-11-28, 15:03:13
 */
...
public class WavePlayer extends javax.swing.JInternalFrame implements PlayListener {
    ...
    private final JPanel cursorPanel;
    private final JComponent wavePanel;
    ...
    /** Creates new form WavePlayer */
    public WavePlayer(Wave wave) {
      this.wave = wave;
      initComponents();
      setTitle(wave.filename);

      wavePanel = new JComponent() {
  ...
  private void initComponents() {
    ...
    timePanel = new javax.swing.JPanel(){
      ...
      containingPanelLayout.setHorizontalGroup(
        ...
        .addComponent(scrollBar, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
        .addComponent(layerPane, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
      ...
      containingPanelLayout.setVerticalGroup(
        ...
        .addGroup(containingPanelLayout.createSequentialGroup()
          ...
          .addComponent(layerPane, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
          .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
          .addComponent(scrollBar, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE))
      );
      ...
      layout.setHorizontalGroup(
        ...
        .addComponent(infoLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
        .addComponent(containingPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
      );
      layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
          ...
          .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
          .addComponent(containingPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
          .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void fftButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fftButtonActionPerformed
      ...
      frame.setTitle(wave.filename + " (FFT)");
      JDesktopPane desktop = getDesktopPane();
...
//		if(waveImage == null) return;
    try {
      if (containingPanel.getWidth() <= 0 || containingPanel.getHeight() <= 0) {
        return;
      }
